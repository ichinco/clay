   ...
   var displayArr = {
    ...
    $(".ticAddTagItem").children(".ticBn").click(function(evt)
	  ...
	  function mousemove(evt)
	  {
	     ...
	     $('.ticAddTagItemCont').children("div:eq(1)").html("width: " 
		+ String(curLeft - initLeft));

	     $('.ticAddTagItemCont').children("div:eq(2)").html("height: "
	        + String(curTop - initTop));
	  ...
	  function mousedown(evt)
	  {
	     ...
	     $('.ticAddTagItemCont').children("div:eq(3)").html("left: " 
		+ String(initLeft));

	     $('.ticAddTagItemCont').children("div:eq(4)").html("top: "
	        + String(initTop));
